                        ...
                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            <thead class="bg-gray-100 dark:bg-gray-700">
                                <tr class="">
                                    ...
                                    <th scope="col"
                                        class="p-4 w-40 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                        Student Name
                                    </th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                @forelse ($scores as $index => $score)
                                    <tr
                                        ...
                                        <td
                                            class="w-2 p-2 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                            <div class="flex items-center">
                                                {{ $loop->iteration }}
                                            </div>
                                        </td>
                                        <td class="flex items-center p-2 mr-2 space-x-6 whitespace-nowrap">
                                        ...
                                        <td
                                            class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                            <div class="flex items-center">
                                                {{ Str::of($score->levels->level)->upper }}/{{ Str::of($score->semesters->sem)->upper }}.
                                            </div>
                                        </td>
                                        ...
                                        <td
                                            class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                            <div class="flex items-center">
                                                {{ Str::of($score->sessions->session)->upper }}/{{ Str::of($score->sessions->session + 1)->upper }}
                                            </div>
                                        </td>
                                        ...
                                        <td
                                            ...
                                            @if ($editingField === $score->registration_id)
                                                <x-text-input required="" wire:model="editedData.score"
                                                    ...
                                                    class=" w-20" type="number" placeholder="score" autofocus />
