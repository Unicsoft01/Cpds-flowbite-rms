<div>
    ...
    <div class="grid grid-cols-1 px-4 xl:grid-cols-1 xl:gap-4">
        <form action="{{ route('co-scores-file.upload') }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            {{-- sort --}}
            <div
                ...
                <div class="grid md:grid-cols-4 gap-6 mb-0">
                    ...
                    <div>
                        <select wire:model="course_id" name="course_id" id="course_id" required
            ...
            <x-importer.import-section
                message="Always use the template file to organize carry over scores to be import" />
