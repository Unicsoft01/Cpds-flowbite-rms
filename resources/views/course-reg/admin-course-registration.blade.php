                        ...
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                ...
                                <th scope="col"
                                    ...
                                    <span class="flex">
                                        Student Fullname {{-- @if ($orderBy !== 'course_title') --}}
                                ...
                                <tr
                                    ...
                                    <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                            ...
                                            <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                                Registered
                                                {{-- {!! date('D, d-M-Y', strtotime($reg->created_at)) !!} --}} by <span class="text-blue-600">
                                                    {{ Str::of($reg->registered_by)->headline->headline }}</span></div>
                                        </div>
                                    </td>
                                    <td
