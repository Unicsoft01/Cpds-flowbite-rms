<div>
    ...
    <div class="px-4">
        ...
        <div
            class="grid w-full grid-cols-1 gap-4 mt-4  @if (auth()->user()->hasRole('User')) md:grid-cols-2 @else md:grid-cols-3 @endif">
            <div
                class="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                <div class="w-full">
                    <h3 class="text-base font-normal text-gray-500 dark:text-gray-400">New Students</h3>
                    <span class="text-2xl font-bold leading-none text-gray-900 sm:text-3xl dark:text-white">
                        {{ number_format($totalStudents) }}
                    </span>
                    <p class="flex items-center text-base font-normal text-gray-500 dark:text-gray-400">
                        <span
                            class="flex items-center mr-1.5 text-sm {{ $growthRate >= 0 ? 'text-green-500' : 'text-red-500' }}">
            ...
            <div
                ...
                <div class="w-full">
                    <h3 class="mb-2 text-base font-normal text-gray-500 dark:text-gray-400">Pass rate</h3>
                    <div class="flex items-center mb-2">
                        <div class="w-16 text-sm font-medium dark:text-white">Passed</div>
                    ...
                    <div class="flex items-center mb-2">
                        <div class="w-16 text-sm font-medium dark:text-white">Carryover</div>
                        <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                    ...
                    <div class="flex items-center mb-2">
                        <div class="w-16 text-sm font-medium dark:text-white">Spillovers</div>
                        <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                    ...
                    <div class="flex items-center mb-2">
                        <div class="w-16 text-sm font-medium dark:text-white">others</div>
                        <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                ...
                <div class="items-center sm:flex">
                    <div class="flex items-center">
                        ...
                        <div id="dropdown" class="z-10 w-56 p-3 bg-white rounded-lg shadow dark:bg-gray-700 hidden"
                            ...
                            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(921.111px, 3237.78px);">
            ...
            <div class="flex items-center justify-between pt-3 sm:pt-6">
                <div>
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        ...
                        data-popper-escaped=""
                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(87.6667px, 6302.67px, 0px);">
