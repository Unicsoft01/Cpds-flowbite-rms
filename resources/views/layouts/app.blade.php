...
<body class="bg-gray-50 dark:bg-gray-800">
                    ...
                    <div class="flex items-center ml-3">
                        <div>
                            <button type="button"
                                ...
                                <img class="w-8 h-8 rounded-full" src="{{ url('/') }}/images/people/profile-picture-5.jpg"
                                    alt="user photo">
                            </button>
                        </div>
    ...
    <script data-navigate-track data-navigate-once src="https://cdn.jsdelivr.net/npm/flowbite@2.5.2/dist/flowbite.min.js"></script>
