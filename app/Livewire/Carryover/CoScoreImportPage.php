...
#[Lazy()]
class CoScoreImportPage extends Component
{
    use WithFileUploads;
    use SharedMethods;
    ...
    {
        return Excel::download(new SampleScoresExport, 'Sample_Carryover-scores.csv');
    }
    
    public function render()
    {
        return view('carryover.co-score-import-page', [
