...
use App\Imports\CoCourseRegisterationsImport;
...
class CoCourseRegImport extends Component
{
    use WithFileUploads;
    ...
    {
        return view('carryover.co-course-reg-import', [
    ...
    public function uploadFile()
    {
        ...
        try {
            ...
            Excel::import(new CoCourseRegisterationsImport($this->dept_id, $this->session_id, $this->level_id, $this->checked, $this->semester_id,  Auth::id()), $name);
    ...
    {
        return Excel::download(new SampleCoCourseRegExport, 'Sample_student_CO_course_reg.csv');
    }
}
 ...
 */
class SampleCoCourseRegExport implements FromCollection, WithHeadings
{
    /**
