...
#[Lazy()]
class CoIndex extends Component
{
    ...
    public CourseRegisterations $CourseRegisterations;
    ...
    // public function mount(CourseRegisterations $CourseRegisterations)
    // {
    //     $this->authorize('view', $CourseRegisterations);
    // }
    ...
    {
        return view('carryover.co-index', [
