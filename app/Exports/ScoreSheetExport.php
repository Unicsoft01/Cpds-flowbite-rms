...
class ScoreSheetExport implements FromQuery, WithProperties, WithHeadings
{
    use Exportable;
    ...
    public function query()
    {
        return CourseRegisterations::query()
            ...
            ->whereIn('course_registerations.registration_id', $this->registeraions)
            ...
            ->select(
                ...
                'course_registerations.score as score',
                'course_registerations.grade_point as grade_point',
                'course_registerations.grade as grade',
            );
    }
}